...
const ReceivedItemsGraph = () => {
    ...
    const submit = () => {
        ...
        userRequest.get(`/inventory/items/received/quantity/${fromDate}/${toDate}`)
        .then(response => {
            setLoading(false)
...
export default ReceivedItemsGraph